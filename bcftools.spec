...
%prep
%setup -q -n bcftools-1.10.1
cd %{_builddir}/bcftools-1.10.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576690654
...
cp %{_builddir}/bcftools-1.10.1/htslib-1.10.1/LICENSE %{buildroot}/usr/share/package-licenses/bcftools/6a9fda1ee5bdca4863a27d95d7b94669a27259fa
%make_install
...
/usr/libexec/bcftools/trio-dnm.so
...
/usr/share/package-licenses/bcftools/6a9fda1ee5bdca4863a27d95d7b94669a27259fa
